...
class SceneWriter {
 public:
  SceneWriter(ros::NodeHandle& nh)
      : new_scene_serv_{nh.serviceClient<world_model_store_msgs::Insert>(
            "/world_model/insert_scene")},
        new_scene_obj_serv_{nh.serviceClient<world_model_store_msgs::Insert>(
            "/world_model/insert_scene_object")},
        new_robot_state_serv_{nh.serviceClient<world_model_store_msgs::Insert>(
            "/world_model/insert_robot_state")} {
